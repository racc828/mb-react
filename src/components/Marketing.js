...
export default class Marketing extends React.Component {
  ...
  componentDidMount() {
    DepartmentDataAdapter.getData("marketing")
    .then((data) => {
      this.setState({
        departmentData: data
      })
  ...
  addData = (data) => {
    DepartmentDataAdapter.addData(data, this.props.currentUser.id, "marketing")
    .then((newData) => {
      this.setState({
    ...
    return(
      <div className="main-body">
        <div className="body-inner">
          <h5>Marketing
            {this.props.currentUser.department == "marketing" || this.props.currentUser.department == "all" ?
